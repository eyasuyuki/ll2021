/* slidy.js (customized version)
   ...
   This version is customized by WWW WATCH in 2007
...
//    start.innerHTML = "print!".localize();
      ...
      slideCounter.style.width = "10em";
      slideCounter.style.bottom = "0";
      slideCounter.style.right = "2em";
      slideCounter.style.padding = "0 1em 1em";
      slideCounter.style.textAlign = "right";
      slideCounter.style.color = "#fff";
      slideCounter.style.background = "#000";
...
function tableOfContents()
{
  ...
  heading.innerHTML = "Page List".localize();

  heading.style.textAlign = "left";
  heading.style.width = "100%";
  heading.style.margin = "0";
  heading.style.marginBottom = "1em";
  heading.style.borderBottomStyle = "dotted";
  heading.style.borderBottomColor = "#000";
